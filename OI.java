...
import org.usfirst.frc.team612.robot.commands.SolenoidCommand;
import org.usfirst.frc.team612.robot.commands.SolenoidCommand_two;
...
public class OI{
	...
	public OI(){
	gunner_button_A.whenPressed(new SolenoidCommand());
	gunner_button_B.whenPressed(new SolenoidCommand_two());
	}
	//// CREATING BUTTONS
